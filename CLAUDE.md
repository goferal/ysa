...
- Fonts: Fraunces for display (a soft modern serif, weight 500, wonky alternates off; big headlines sit in a narrower measure (`max-w-3xl`/`4xl`) with line-height about 1.06, never full width; Bodoni Moda was too hairline to read live and Abril Fatface too much of a poster), Karla for body and kickers, Caveat for asides. Display headings are near-black (`noir`, matching the logo); body copy is maroon.
